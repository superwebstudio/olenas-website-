...
const galleryItems: GalleryItem[] = [
  { id: 1, label: 'Skin rejuvenation', sub: 'Before & after', size: 'wide', src: photo8 },
  { id: 2, label: 'Laser hair removal', sub: 'Treatment in progress', size: 'wide', src: laserImg },
  { id: 3, label: 'Client result', sub: 'After treatment', size: 'normal', src: photo1 },
  { id: 4, label: 'Client result', sub: 'After treatment', size: 'normal', src: photo2 },
  { id: 5, label: 'Skin rejuvenation', sub: 'Texture & tone', size: 'wide', src: photo3 },
  { id: 6, label: 'Skin rejuvenation', sub: 'After sessions', size: 'normal', src: photo4 },
  /* photo10 reads as tattoo/removal; photo9 better matched peel glow — swap so labels match imagery */
  { id: 7, label: 'Tattoo removal', sub: 'Session progress', size: 'normal', src: photo10 },
  { id: 8, label: 'Carbon peeling', sub: 'Hollywood peel — glow', size: 'normal', src: photo9 },
];
